...
const displayedSparks = computed(() => showAllMySparks.value ? mySparks.value : mySparks.value.slice(0, 2));
...
onMounted(async () => {
  try {
    ...
    if (data.name) {
      ApplicationSettings.setString('user_name', data.name);
    }
  } catch (e) {
  }
});
...
.content-container { padding: 0 20px 20px 20px; }
.profile-header { align-items: center; margin-top: 20px; margin-bottom: 30px; }
.avatar { width: 210px; height: 210px; border-radius: 40px; margin: 20px; }
.profile-name { font-family: 'Nunito', sans-serif; font-size: 22px; font-weight: 800; color: #181820; text-align: center; margin-top: 20px; margin-bottom: 20px; }
.profile-level { font-family: 'Nunito Sans', sans-serif; font-size: 16px; background-color: #f59741; color: white; padding: 4px 16px; border-radius: 40px; margin: 20px; margin-bottom: 0; text-align: center; width: 45%; }
.section-header { margin-bottom: 16px; }
.section-title { font-family: 'Nunito', sans-serif; font-size: 16px; font-weight: 600; color: #181820; margin-left: 20px; margin-bottom: 30px; margin-top: 30px; }
.view-all-label { background-color: transparent; color: #8e5eed; font-family: 'Nunito Sans', sans-serif; font-size: 12px; font-weight: 500; padding: 0; margin: 0; margin-top: 14px; margin-right: 20px; text-align: right; }
.achievements-grid { margin-bottom: 30px; margin-left: 20px; margin-right: 20px; }
.achievement-card { background-color: #f9f9fb; border-radius: 25px; padding: 12px; align-items: center; margin: 4px; }
.achievement-image { width: 100px; height: 100px; margin-bottom: 8px; }
.achievement-title { font-family: 'Nunito Sans', sans-serif; font-size: 12px; font-weight: 500; color: #181820; text-align: center; }
.sparks-list { margin-bottom: 20px; }
.spark-item { background-color: white; border-radius: 30px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1); padding: 16px; margin: 20px; margin-bottom: 12px; align-items: center; }
.spark-image { width: 200px; height: 200px; border-radius: 20px; margin-right: 16px; }
.spark-info { width: 100%; }
.spark-title { font-family: 'Nunito Sans', sans-serif; font-size: 16px; font-weight: 600; color: #181820; margin-bottom: 8px; margin-left: 20px; }
.progress-row { align-items: center; margin-left: 20px; }
